...
2. **New docs**: `mintlify/tenant/{tenant_id}/` - Hidden documentation pages for 16 tenants
...
- `mintlify/tenant/zbiotics/custom-objects.mdx` - Has 100+ objects across many datasets

**Medium-usage tenant:**
- `mintlify/tenant/neurogum/custom-objects.mdx` - Has ~46 objects, manually enhanced

**Low-usage tenant:**
- `mintlify/tenant/catalinacrunch/custom-objects.mdx` - Has only 7 objects
...
| `mintlify/tenant/README.md` | Documentation structure |
| `mintlify/tenant/neurogum/custom-objects.mdx` | Example with manual enhancements |
| `mintlify/tenant/zbiotics/custom-objects.mdx` | Complex multi-dataset example |
...
1. Revert the `mintlify/tenant/` directory

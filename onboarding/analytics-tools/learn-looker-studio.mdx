...
### Overview
Google provides a very useful high-level overview and quick-start guide for Looker Studio [HERE](https://support.google.com/looker-studio/answer/9171315?hl=en#zippy=).  If you're more of a visual learner, this 20 minute crash course will get you up and running.
...
We know teams are busy, this is why SourceMedium provides a suite of template reports and data sources for your business to leverage out of the box.  [Learn how to use our Looker Studio templates](/data-activation/template-resources/looker-studio-template-copy-instructions), or checkout our template directories:
- [Looker Studio data source templates](/data-activation/template-resources/sm-data-source-template-directory)
- [Looker Studio report templates](/data-activation/template-resources/sm-report-template-directory)

## Creating & Editing Data Sources

<AccordionGroup>
    <Accordion title="Creating new data sources">
        You can provision data sources directly based on tables in your BQ (create a new data source out of an entire table like `obt_orders`), or write your own queries to derive new tables based on tables within your warehouse.

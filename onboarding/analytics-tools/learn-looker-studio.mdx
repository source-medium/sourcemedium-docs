...
description: "Onboarding guide: Learn Looker Studio."
icon: "book"
---

<Info>
**This page has moved.** For the complete Looker Studio guide including data sources, calculated fields, and sharing, see [Looker Studio Guide](/onboarding/analytics-tools/looker-studio-guide).
</Info>

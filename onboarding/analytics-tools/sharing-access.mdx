...
description: 'Onboarding guide: Granting Access to View & Edit Access Your Dashboard or Configuration Sheet.'
icon: "book"
---

<Info>
**This page has moved.** For comprehensive access control guidance, see:
- [Google Groups Access Control](/onboarding/analytics-tools/google-groups-access-control) — Create and manage groups for team access
- [Looker Studio Guide](/onboarding/analytics-tools/looker-studio-guide) — Share dashboards and data sources
</Info>

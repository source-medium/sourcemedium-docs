...
<Info>
**This page has moved.** For practical SQL queries, table references, and BigQuery essentials, see [BigQuery Essentials](/onboarding/analytics-tools/bigquery-essentials).
</Info>

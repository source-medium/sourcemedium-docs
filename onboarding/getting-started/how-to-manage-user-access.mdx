...
<AccordionGroup>
    ...
    <Accordion title="BigQuery - View Tables">
    ...
    <Accordion title="BigQuery - Edit Tables">
...
### <Icon icon="user-group" iconType="solid" size={32}/> $~$ SourceMedium Recommended Access Group Setup

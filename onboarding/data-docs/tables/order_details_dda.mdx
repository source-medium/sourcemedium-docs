...
| `order_net_revenue` | Revenue after discounts and refunds |
| `order_gross_revenue` | Revenue before discounts and refunds |
| `sm_channel` | Primary channel classification |
| `sm_valid_order_index` | Customer's valid order number (1 = first order) |

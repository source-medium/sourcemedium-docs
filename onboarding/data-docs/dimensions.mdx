...
|-----------|------------|----------------|
| `sm_channel` | Primary channel classification for orders and marketing | `Online DTC`, `Amazon`, `TikTok Shop`, `Retail` |
| `sm_sub_channel` | Granular breakdown within a channel | `Paid Social`, `Organic`, `Affiliates`, `Email` |
...
| Dimension | Definition | Example Values |
|-----------|------------|----------------|
| `source_system` | Advertising platform source | `Meta`, `Google Ads`, `TikTok` |

...
to your site traffic -- which we pair against real order volume (as-reported by your sales platform) to build an accurate CVR picture.
...
<Accordion title="Transformed GA4 data is surfaced to the following report modules by default">
    - [Executive Summary](/source-medium-university/report-docs/report-pages/executive-summary-module)
        - Site traffic (`sessions`) and `CVR`
    - [Traffic Deep Dive](/source-medium-university/report-docs/report-pages/traffic-deep-dive-module)
    ...
    - [Orders Deep Dive](/source-medium-university/report-docs/report-pages/orders-deep-dive-module)
        - GA4-enriched last-click attribution of orders data
    - [Product Performance](/source-medium-university/report-docs/report-pages/product-performance-module)
        - GA4-enriched last-click attribution for line-item sales data
    - [New Customer Analysis](/source-medium-university/report-docs/report-pages/new-customer-analysis-module)
        - GA4-enriched customer acquisition last-click attribution
    - [Customers - Last Order Analysis](/source-medium-university/report-docs/report-pages/last-order-analysis-module)
...
<AccordionGroup>
    <Accordion title="What do “Direct / None” & “None / None “ Source / Mediums mean?">
        ...
        on how to improve your UTM tracking in Google Analytics [here](/data-inputs/platform-supporting-resources/ga4/proper-google-analytics-setup).
    </Accordion>

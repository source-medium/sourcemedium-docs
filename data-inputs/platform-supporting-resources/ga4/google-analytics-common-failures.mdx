...
Google Analytics has some common failure points that can cause data sources to diverge.  Let's explore a couple of these below:
    ...
    - Faulty Tracking
        ...
        The best practices we have identified are covered in [Improving Your Last-Click (UTM) Attribution](/data-inputs/platform-supporting-resources/ga4/improving-last-click-attribution) and this [template](https://docs.google.com/spreadsheets/d/14hx6hlce6zTwfMIcuKLUIuOYl5uWVlcyCr9FIL0GQJk/edit#gid=0).

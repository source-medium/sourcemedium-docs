...
## Follow this integration guide to connect your Bing Ads data to Source Medium dashboards.
...
3. Wait for an email from Microsoft Ads with a request from Source Medium to link to the account with **Standard access**

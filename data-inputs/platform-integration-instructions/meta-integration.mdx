...
**Please Note:** *SourcMedium reports Meta data on the attribution window set at the campaign level.  We sometimes see different windows set between campaigns, which can cause confusion when validating vs. the Meta UI*
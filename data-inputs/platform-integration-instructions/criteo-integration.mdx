...
4. Fill out fields for the new app project and create the app 
    1. Name field = SourceMedium Integration
...
6. Share the **file (or actual IDs) containing** the **client_id** and **client_secret** credentials with SourceMedium by emailing **[integrations@sourcemedium.com](mailto:integrations@sourcemedium.com)**
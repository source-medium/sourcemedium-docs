...
<Info>
Your Configuration Sheet is automatically synced to SourceMedium. Changes reflect after the next scheduled refresh; timing can vary by feature.
</Info>
...
1. Log in to SourceMedium
2. Navigate to **Settings** > **Configuration Sheet**
3. Click the Google Sheets link to open your sheet

...
description: "Learn about How do I surface Operating Expenses within my dashboard? in SourceMedium."
...
2. Please let the SourceMedium team know that you've inputted the operating expenses and we will enable costs to be picked up automatically moving forward. *Historical data can be inputted into this sheet to update prior periods.* 

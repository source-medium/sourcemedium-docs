...
When the store-level health metric tells you something is wrong, move to row-level order debugging in BigQuery.

<Card title="Order Attribution Audit Table" icon="table" href="/data-activation/data-tables/sm_transformed_v2/fct_order_attribution_audit">

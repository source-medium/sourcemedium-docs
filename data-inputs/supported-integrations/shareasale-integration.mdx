...
5. Find ShareASale and select it
    ...
    ![](/images/article-imgs/shareasale-images/Untitled1.png)
    
6. Click “Add Credentials”
    
    ![](/images/article-imgs/shareasale-images/Untitled2.png)
    
7. Input the API token and secret key from the email
    
    ![](/images/article-imgs/shareasale-images/Untitled3.png)
    
8. Once those are input, navigate back to “My Credentials” and select the corresponding token 
    
    ![](/images/article-imgs/shareasale-images/Untitled4.png)
    
9. Input their Merchant ID from the Email
    
    ![](/images/article-imgs/shareasale-images/Untitled5.png)

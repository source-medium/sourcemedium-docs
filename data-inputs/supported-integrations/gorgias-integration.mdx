...
- **Admin Access** to your Gorgias account to add Source Medium as an **Admin Agent**
- Premium Integration
...
1. Fill in the Name as Source Medium, Email as integrations@sourcemedium.com, and make sure to select the **Role as Admin Agent**

...
<CardGroup cols={2}>
  <Card title="BigQuery Project" icon="database" href="https://console.cloud.google.com/bigquery?project=sm-zbiotics">
    Open sm-zbiotics in BigQuery Console
  </Card>
  <Card title="Custom Objects" icon="table" href="/tenants/zbiotics/custom-objects">

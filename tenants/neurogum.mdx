---
title: "Neurogum"
sidebarTitle: "Neurogum"
description: "Data documentation for Neurogum"
icon: "building"
---
...
<CardGroup cols={2}>
  <Card title="BigQuery Project" icon="database" href="https://console.cloud.google.com/bigquery?project=sm-neurogum">
    Open sm-neurogum in BigQuery Console
  </Card>
  <Card title="Custom Objects" icon="table" href="/tenants/neurogum/custom-objects">

...
<CardGroup cols={2}>
  <Card title="BigQuery Project" icon="database" href="https://console.cloud.google.com/bigquery?project=sm-xcvi">
    Open sm-xcvi in BigQuery Console
  </Card>
  <Card title="Custom Objects" icon="table" href="/tenants/xcvi/custom-objects">

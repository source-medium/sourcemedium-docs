...
<CardGroup cols={2}>
  <Card title="BigQuery Project" icon="database" href="https://console.cloud.google.com/bigquery?project=sm-idyl">
    Open sm-idyl in BigQuery Console
  </Card>
  <Card title="Custom Objects" icon="table" href="/tenants/idyl/custom-objects">

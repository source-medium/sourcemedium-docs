...
<AccordionGroup>
    ...
    <Accordion title="Where does SourceMedium MTA data come from?">
        ...
        <Note>Learn more about the basics of SourceMedium MTA in our [MTA Overview](/mta/mta-overview)</Note>
    </Accordion>
    ...
    <Accordion title="How do I use SourceMedium MTA built-in reporting?">
    ...
    <Accordion title="What are the three attribution types within SourceMedium MTA?">
    ...
    <Accordion title="How does linear attribution handle duplicate touches?">
        ...
        **Technical Note**: This deduplication applies to all attribution dimensions - marketing channels, ads, campaigns, ad groups, landing pages, and email/SMS. Each dimension tracks its own "first occurrence" within sessions.
        ...
        <Note>Learn more about the technical implementation in our [MTA Advanced Documentation](/mta/mta-advanced-documentation#linear-attribution-deduplication)</Note>
    </Accordion>

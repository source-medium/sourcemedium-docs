...
description: "Step-by-step guide to creating Google Groups for managing team access to your SourceMedium dashboard and BigQuery data"
icon: 'question-mark'
---

<Info>
**Looking for the complete guide?** See [Google Groups Access Control](/onboarding/analytics-tools/google-groups-access-control) for how to use Google Groups to manage access across Looker Studio, BigQuery, and Google Sheets.
</Info>

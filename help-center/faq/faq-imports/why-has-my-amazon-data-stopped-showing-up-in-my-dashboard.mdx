...
sidebarTitle: "Why Amazon data stopped appearing?"
icon: 'question-mark'
---
### Requirements
...
1. **Updating Seller Central**
    1. In your Seller Central account, go to **Settings >**  **User Permissions** page > [**Manage your Apps**](https://sellercentral.amazon.com/apps/manage) section. Find "SourceMedium" and enable access, Amazon will create a new MWS Auth token. 

...
### How is `{Platform}` data used in Source Medium?
**Integrated `{Platform}` data is surfaced to the following modules by default**
- Executive Summary
...
- `executive_summary`
- etc. (list / link out to specific BQ table names)
</Accordion>

## Cleaning & Transformation 
### What default cleaning does Source Medium do to `{Platform}` data?
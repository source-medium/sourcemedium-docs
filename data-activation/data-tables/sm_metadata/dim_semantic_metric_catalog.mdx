  ...
  - name: dim_semantic_metric_catalog
    ...
    columns:
      ...
      - name: filter_condition
        description: >
          Filter condition applied to the metric, if any.
          Extracted from MetricFlow/dbt metric definitions.
          NULL if no filter is applied (or if the filter cannot be extracted).
      ...
      - name: cumulative_settings
        description: >
          ...
          - "30 days", "90 days", "365 days" for trailing windows

...
models:
  - name: rpt_executive_summary_daily
    ...
    - name: non_recurring_subscription_order_net_revenue
      description: >
        The net order revenue from non-recurring subscriptions.
    ...
    - name: non_recurring_subscription_order_gross_revenue
      description: >
    ...
    - name: non_recurring_subscription_order_count
      description: >

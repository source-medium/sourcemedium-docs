...
The AI Analyst is delivered as a Slack app called **SourceMedium** in your company's workspace. This page covers how to get set up and what to expect.
...
Each SourceMedium customer has a dedicated instance at:
...
When you install the app, Slack will show the permissions being requested. The key permissions include:

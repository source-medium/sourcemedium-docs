...
<Note>
To pin to a specific version, add `@v1.0.1`: `npx skills add source-medium/skills@v1.0.1 --skill sm-bigquery-analyst`. See [github.com/source-medium/skills/releases](https://github.com/source-medium/skills/releases) for available versions.
</Note>

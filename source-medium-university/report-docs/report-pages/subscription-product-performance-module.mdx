...
[Please read the 'Potential Discrepancies' section of the Subscription Overview module page to see how ReCharge subscription metrics are calculated in SourceMedium Reports.](/source-medium-university/report-docs/report-pages/subscription-overview-module.mdx)

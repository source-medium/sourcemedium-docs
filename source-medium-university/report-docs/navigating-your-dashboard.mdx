...
description: "Let's explore some of the basic features that allow your team to quickly navigate your data within Source Medium:"
---
...
<Frame type="glass">
    <img src="/images/article-imgs/navigating-your-dashboard/report-documentation-key.avif"/>
</Frame>
...
<Frame type="glass">
    <img src="/images/article-imgs/navigating-your-dashboard/date-range-filter.avif"/>
</Frame>
...
<Frame caption="Chart at the day level">
    <img src="/images/article-imgs/navigating-your-dashboard/row-up-down-icons.avif"/>
</Frame>

<Frame caption="Same chart after 'drilling up' using the small arrows (weekly granularity)">
    <img src="/images/article-imgs/navigating-your-dashboard/chart-on-weekly-granularity.avif"/>
</Frame>
...
<Frame type="glass">
    <img src="/images/article-imgs/navigating-your-dashboard/channel-filter.avif"/>
</Frame>
...
<Frame type="glass">
    <img src="/images/article-imgs/navigating-your-dashboard/brand-id-selector.avif"/>
</Frame>
...
<Frame type="glass">
    <img src="/images/article-imgs/navigating-your-dashboard/optional-metrics-selector.avif"/>
</Frame>
...
<Frame type="glass">
    <img src="/images/article-imgs/navigating-your-dashboard/reset-current-filters.avif"/>
</Frame>
...
#### Exporting data
The data is yours! Any user can export any of the data shown in Source Medium.
...
![](/images/article-imgs/navigating-your-dashboard/exporting-looker-data-step-1.avif)

**2.** Select `Export`
![](/images/article-imgs/navigating-your-dashboard/exporting-looker-data-step-2.avif)

**3.** Name the export, and select the export format
![](/images/article-imgs/navigating-your-dashboard/exporting-looker-data-step-3.avif)
</Accordion>